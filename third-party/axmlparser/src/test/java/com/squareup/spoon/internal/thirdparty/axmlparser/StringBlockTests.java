...
public class StringBlockTests {
    ...
    public void testParseApk(String apkFilePath) throws Exception {
    ...
    /**
     * Common test helper that is used to test both UTF-8 and UTF-16 input data and expected results.
     *
