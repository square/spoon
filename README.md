...
We recommend using [Stanfy's plugin][3] for Android Gradle Plugin <3.0 or [Jared's plugin][4] for Android Gradle Plugin 3.0+ (currently maintained as separate projects).
